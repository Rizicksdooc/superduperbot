...
var token = "NTA0NzEyODQ0ODkwMDc5MjMy.DrJCKg.Q_gE9gfME9hVQ-Uu6qE4EHlYhpo"
client.login(token)

roblox.login({username: "PerseusLegion", password: "Jhinisfat"}).then((success) => {

}).catch(() => {console.log("Sorry, it failed.");});


client.on("ready", () => {
  client.user.setGame(`Serving the Legion!`);
